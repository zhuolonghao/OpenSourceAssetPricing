...
#   Debt capacity is positively associated with stock returns in the cross section of financially constrained firms
#   Debt capacity has no systematic relation with the cross section of financially unconstrained firms’ stock returns
#   financial constrain is measured by four criteria, respectively, for robustness:
#       i) asset size in terms of the book value of total assets,
#       ii) payout ratio,
#       iii) bond ratings, and
#       iv) commercial paper ratings.
finQ[[x for x in finQ.columns if 'ppe' in x.lower()]].count()
